...
public class XemThongtinJFrameNhanvien extends JFrame implements ActionListener{
	...
	public XemThongtinJFrameNhanvien() {
	...
	public static void main(String[] args) {
		new XemThongtinJFrameNhanvien().setVisible(true);
	}
