...
import ui.Hethong.XemThongtinJFrameNhanvien;
...
public class MenuQuanly extends JFrame implements ActionListener{
	...
	public MenuQuanly() {
		...
		mniTKDT.setEnabled(false);
		mniTKHoadon.setEnabled(false);
		mniTKThuocHH.setEnabled(false);
		mniTKTN.setEnabled(false);
		...
		JLabel wIcon = new JLabel(new ImageIcon(getClass().getResource("/image/login.jpg")));
													...
													if (o.equals(mniDangxuat)) {
														...
														if (o.equals(mniDoiMK)) {
															...
															if (o.equals(mniThoat)) {
																...
																XemThongtinJFrameNhanvien xemUI = new XemThongtinJFrameNhanvien();
